...
//   出典: http://kanjivg.tagaini.net  (kanji/05927.svg)
// viewBox: 0 0 109 109（KanjiVG 標準）
// 書き順は KanjiVG 正規順（自動抽出）
// 動作語出典: smileplanet 1056_dai.pdf（手書きで songFragment / songLyric を埋めること）
export const KANJI_OO = {
  char: '大',
  reading: 'おお',
  meaning: 'おおさかふの大',
  word: 'おお',
